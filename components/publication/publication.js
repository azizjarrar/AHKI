...
const publication = (props) => {
    ...
    return (
        <div className={Styles.container}>
            <div className={Styles.userImageAndNameAndTimeAndSettings}><div className={Styles.userImage}></div><div className={Styles.Name}><h3 className={Styles.nameh3}>Aziz Jarrar</h3></div><div className={Styles.Settings}><div className={Styles.settings}></div></div></div>
             ...
             {comments&&<div className={Styles.commentsContainer}>
                 <Comment text={"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make"}></Comment>
