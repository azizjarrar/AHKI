...
const Comment = (props) => {
 ...
 if(publication!=undefined){
  ...
  return (
    <div className={Styles.container} style={likesModal?{zIndex:"999999999999999999"}:{}}>
      ...
      <div className={Styles.imageUserAndNameContainer}>
        <div className={Styles.userImage}>
          ...
          <div className={Styles.Settings} onClick={() => ShowSettings()}>{settings && <CommentOrPostSettings  imgid={props.imgid} ></CommentOrPostSettings>}</div></div>
