...
const PostTodayTopic = () => {
    ...
    const openEmojiDisplay = () => {
      ...
      const getSelectedEmoji=(e,pack)=>{
          ...
          text.innerHTML = text.innerHTML + (`<img  class="EmojiInInputcss" src=${e}>`)
