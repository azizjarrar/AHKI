...
const profile = (props) => {
  ...
  React.useEffect(()=>{
    if(props.state!=false){
      ...
      countFollowersOfUser({userid:props.user._id},props.token).then(result=>{
    ...
    <div className={Style.container}>
      ...
      <div className={Style.profile}>
        ...
        <div className={Style.profileStatus}>
          <h3 onClick={()=>openFollowing()}>{followingCount} {language.Following}</h3> 
          <h3 onClick={()=>openFollowers()}>{followersCount} {language.Followers}</h3>
