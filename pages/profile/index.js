...
import {GetUserData,ChangeProfileImage} from '../../services/user'
const Profile = (props) => {
    const [user,setUser]=React.useState({following:0,Followers:0})
    ...
    ******************************************************************************************/
    const [language, setlanguage] = React.useState({
        ...
        UpdateProfile: languageDoc.Language.Profile.UpdateProfile["eng"],
        YourPosts: languageDoc.Language.Profile.YourPosts["eng"],
    ...
    React.useEffect(() => {
        ...
        setlanguage({
            ...
            UpdateProfile: languageDoc.Language.Profile.UpdateProfile[localStorage.getItem("language")],
            YourPosts: languageDoc.Language.Profile.YourPosts[localStorage.getItem("language")],
            Likes: languageDoc.Language.Profile.Likes[localStorage.getItem("language")]
        })
    ...
    ******************************************************************************************/
    ...
    const changeFile=(e)=>{
        ...
        ChangeProfileImage(formData,props.token).then((data)=>{
            setUser(e=>{
                return{
                    ...e,
