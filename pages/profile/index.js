                ...
                <div className={Style.timeLine}>
                    ...
                    <PostUsersStorys refrechData={refrechDataFn}></PostUsersStorys>
                        <div className={Style.publicationContainer}>
                            {posts.map(e=><Publication  userName={user.userName} ownerid={e.userNameOwnerOfPost} commentsNumber={e.comments} likesNumber={e.likes}  id={e._id}  date={e.date} ownerOfPostImage={user.currentImageUrl} key={e._id} text={e.postText}  image={e.postImage!=undefined?e.postImage:undefined}></Publication>)}
                        </div>
                    </div>
